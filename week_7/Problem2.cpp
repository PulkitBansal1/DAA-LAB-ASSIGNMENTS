//design algorithm using program to solve previous question using bellman ford shortest path
//bellman works in negative edge weights unlike dijkstra
//in negative edge weight cycle it may not work
#include<bits/stdc++.h>
using namespace std;
...
cin>>source;  //entering source from user from where we need to calcculate path to all other locations
